...
def main():
    ...
    pipeline_description = ('pravegasrc name=src ! decodebin ! videoconvert ! videoscale ! video/x-raw,width=1280,height=720,format=RGB ! videoconvert ! ' +
                            'example_transform_cv ! fakesink')
