...
def make_parser111(path):
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="./model/multiobject/yolox_voc_s_p_c.py",
        type=str,
        help="pls input your expriment description file",
    )
    parser.add_argument("-c", "--ckpt", default="./model/multiobject/best_first_step_detect.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
