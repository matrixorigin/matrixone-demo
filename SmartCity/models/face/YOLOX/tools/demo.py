...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="/home/littlesc/FR/face.evoLVe.PyTorch-master/test_dataset", help="path to images or video"
    )
...
if __name__ == "__main__":
    ...
    #print(args.exp_file, args.name)#exps/default/yolox_s.py None
